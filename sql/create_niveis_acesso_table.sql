...
AND p.nome IN (
 ...
 clientes_visualizar,pets_visualizar',agendamentos_visualizar'
)
ON DUPLICATE KEY UPDATE nivel_id = nivel_id;
...
AND p.nome IN (
  dashboard_visualizar',
 clientes_visualizar,clientes_criar', 'clientes_editar,  pets_visualizar, 'pets_criar,pets_editar',agendamentos_visualizar,agendamentos_criar', 'agendamentos_editar',
  caixa_visualizar', caixa_lancar,relatorios_visualizar'
)
ON DUPLICATE KEY UPDATE nivel_id = nivel_id;
...
AND p.nome IN (
  dashboard_visualizar',agendamentos_visualizar,agendamentos_criar', 'agendamentos_editar',
 clientes_visualizar,clientes_criar,  pets_visualizar,pets_criar'
)
ON DUPLICATE KEY UPDATE nivel_id = nivel_id; 