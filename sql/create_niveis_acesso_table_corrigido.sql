...
('usuario', 'Usuário básico', '#667eea'),
('operador', 'Operador de agendamentos', '#d97706'),
('tosador', 'Tosador especializado', '#7c3aed'),
('veterinario', 'Veterinário', '#0891b2'),
('recepcionista', 'Recepcionista', '#059669')
...
-- Clientes
('clientes_visualizar', 'Visualizar lista de clientes', 'clientes'),
('clientes_criar', 'Criar novos clientes', 'clientes'),
('clientes_editar', 'Editar clientes existentes', 'clientes'),
...
('agendamentos_criar', 'Criar novos agendamentos', 'agendamentos'),
